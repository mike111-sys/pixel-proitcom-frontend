...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  return (
    <>
      <div>
        <title>Contact Us | Pixelpro Technology</title>
        <meta name="description" content="Get in touch with Pixelpro Technology for inquiries, support, or partnerships. We're here to help with all your tech needs." />
      </div>
